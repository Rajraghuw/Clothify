          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
               ...
               <div data-aos="zoom-in" >
                    ...
                    className='max-w-[400px] h-[350px]
                     w-full mx-auto drop-shadow-[-10px_10px_12px_rgba(0,0,0,1)] object-cover' />
               </div>
               ...
               <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                ...
                <p data-aos="fade-up"  className='text-sm text-gray-500 tracking-wide leading-5'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea libero, voluptas soluta nihil eum modi atque impedit consequuntur quasi consectetur dolor id in qui vitae!
                </p>
                <div className='flex flex-col gap-4'>
                  <div data-aos="fade-up" className='flex items-center gap-4'>
                    <GrSecure className='text-4xl w-12 h-12 shadow-sm
                    p-4 rounded-full bg-violet-100 dark:bg-violet-400
                    '/>
                    <p>Quality Product</p>
                  </div>
                  <div data-aos="fade-up" className='flex items-center gap-4'>
                    <IoFastFood className='text-4xl w-12 h-12 shadow-sm
                    p-4 rounded-full bg-orange-100 dark:bg-orange-400
                    '/>
                    <p>Fast Deievery</p>
                  </div>
                  <div data-aos="fade-up" className='flex items-center gap-4'>
                    <GiFoodTruck className='text-4xl w-12 h-12 shadow-sm
                    p-4 rounded-full bg-green-100 dark:bg-green-400
                    '/>
                    <p>Easy Payment Methoud</p>
                  </div>
                  <div data-aos="fade-up" className='flex items-center gap-4'>
                    <GiFoodTruck className='text-4xl w-12 h-12 shadow-sm
